...
import { Plus, ArrowLeft, X, AlertCircle, Loader2 } from 'lucide-react';
import { useCodeChallenge } from '../../context/CodeChallengeContext';
import type { CreateTrackFormData, ProgrammingLanguage, TrackDifficultyLevel, TrackCategory } from '../../types';
    ...
    <div className="card">
      ...
      <div className="px-6 py-4 border-b border-[#2a2a2e]">
        <div className="flex items-center gap-3">
          ...
          <h2 className="font-mono text-lg font-semibold text-[#f5f5f4]">Create New Track</h2>
        </div>
      </div>
